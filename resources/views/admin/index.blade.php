    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-200">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3 gap-4">
                    <p class="flex items-center"><i class="fa-brands fa-php fa-lg me-2" style="color:#777BB4" aria-hidden="true"></i> <span>{{ phpversion() }}</span></p>
                    <p class="flex items-center"><i class="fa-brands fa-laravel fa-lg me-2" style="color:#FF2D20" aria-hidden="true"></i> {{ \Illuminate\Foundation\Application::VERSION }}</p>
                    <div>
                    ...
                    <div class="z-50 hidden m-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-[150px]" id="dropdown-user">
...
<div class="p-4 sm:ml-64">
    <div class="grid grid-cols-3 gap-4 mb-4 mt-[60px]">
