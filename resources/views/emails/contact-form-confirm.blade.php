...
<body style="mso-line-height-rule:exactly; word-break:break-word; -ms-text-size-adjust:100%; -webkit-text-size-adjust:100%; margin:0; padding:0; width:100%">
                            ...
                            <table width="520" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:520px;max-width:520px;">
                                <tr>
                                    <td align="center" class="container-padding">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                            <tr>
                                                <td align="center" valign="middle" style="color:#191919;font-size:24px;line-height:40px;font-weight:700;letter-spacing:0;padding: 0 0 10px;">Děkujeme za zprávu!</td>
                                            </tr>
                                            <tr>
                                                <td align="center" valign="middle" style="color:#191919;font-size:16px;line-height:24px;letter-spacing:0;padding: 0 0 10px;">Tímto Vám potvrzujeme, že jsme obdrželi Vaši zprávu a brzy se Vám ozveme.</td>
                                            </tr>
                                            <tr>
